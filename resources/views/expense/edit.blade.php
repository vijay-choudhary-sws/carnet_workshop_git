    ...
    <div class="right_col" role="main">
                        ...
                        <nav>
                            <div class="nav toggle">
                                <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a
                                    href="{!! url('/expense/list') !!}" id=""><i class=""><img
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form id="expenseEditForm" method="post" action="{{ route('expense.update') }}"
                            ...
                            <div class="row mt-3 row-mb-0">
                                ...
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4"
                                        for="status">{{ trans('message.Category') }} <label class="color-danger">*</label>
                                    </label>
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 d-flex">
                                        <select name="category_id" id="category-id" class="form-control form-select select2"
                                            required>
                                            <option value="" selected disabled>{{ trans('message.Select Category') }}</option>
                                            @foreach ($categories as $category)
                                                <option value="{{$category->id}}" @selected($expense->category_id == $category->id)>{{$category->title}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                        <select class="form-control form-select select2" name="supplier_id">
                                          ...
                                          @foreach ($suppliers as $supplier)
                                              <option value="{{$supplier->id}}" @selected($supplier->id == $expense->supplier_id)>{{$supplier->name.' '.$supplier->lastname}}</option>
                                          @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <input type="text" id="bill_number" name="bill_number" class="form-control"
                                            ...
                                            placeholder="Enter Bill Number Here..." required />
                                    </div>
                                </div>
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4"
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <input type="text" id="outdate_gatepass" name="date" autocomplete="off"
                                            class="form-control expenseDate datepicker"
                                ...
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <input type="number" id="total-amount" class="form-control text-input"
                                            value="{{ $expense->total_amount ?? '0' }}" name="total_amount"
                                            placeholder="Enter Total Amount Here..." maxlength="10" required
                                            oninput="getTotal()">
                                    </div>
                                </div>
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <input type="number" id="paid-amount" class="form-control text-input"
                                            value="{{ $expense->paid_amount ?? '0' }}" name="paid_amount"
                                            placeholder="Enter Paid Amount Here..." maxlength="10" required
                                            oninput="getTotal()">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <input type="number" id="balance-amount"
                                            class="form-control text-input bg-secondary text-white "
                                            value="{{ $expense->balance_amount ?? '0' }}" name="balance_amount"
                                            placeholder="Enter Balance Amount Here..." readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row row-mb-0">
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <textarea name="description" class="form-control" id="description" placeholder="Enter Description Here...">{{ $expense->description ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                          ...
                          <a class="btn btn-primary" href="{{ URL::previous() }}">{{ trans('message.CANCEL') }}</a>
                                ...
                                <div
                                    ...
                                    <button type="submit"
                                        class="btn btn-success updateExpenseButton">{{ trans('message.UPDATE') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
