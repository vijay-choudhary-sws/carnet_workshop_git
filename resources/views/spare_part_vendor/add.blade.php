...
<div class="right_col" role="main" style="background-color: #e6e6e6;">
      ...
      <div class="nav_menu">
        <nav>
          <div class="nav toggle">
           <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{!! url('/sparepartvendor/list') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"></i><span class="titleup" style="margin-right: 4px;"> {{ trans('message.Add Spare Part Vendor') }}</span>
            </a>
          </div>
  ...
  <div class="row">
    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_content">
          <form id="sparepartvendor_add_form" action="{!! url('/sparepartvendor/store') !!}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask supportSttafAddForm">
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group my-form-group has-feedback">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 gender">
                  <input type="radio" name="gender" value="0">{{ trans('message.Male') }}
...
<script>
  $(document).ready(function() {
    ...
    $('body').on('click', '.supportSttafsubmitButton', function(e) {
      $('#sparepartvendor_add_form input, #sparepartvendor_add_form select, #sparepartvendor_add_form textarea').each(
...
{!! JsValidator::formRequest('App\Http\Requests\StoreSparePartVendorAddEditRequest', '#sparepartvendor_add_form') !!}
