      ...
      <div class="nav_menu">
        <nav>
          <div class="nav toggle">
            <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup"><a href="{!! url('/sparepartvendor/list') !!}"><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="me-2 back-arrow"> {{ $sparepartvendor->name . ' ' . $sparepartvendor->lastname }}</span></a>
          </div>
    ...
    <div class="row">
      <div class="col-xl-10 col-md-9 col-sm-10">
        <div class="user_profile_header_left">
          <img class="user_view_profile_image" src="{{ URL::asset('public/spare_part_vendor/' . $sparepartvendor->image) }}">
          <div class="row">
            <div class="view_top1">
              <div class="col-xl-12 col-md-12 col-sm-12">
                <label class="nav_text h5 user-name">
                  {{ $sparepartvendor->name . ' ' . $sparepartvendor->lastname }}&nbsp;
                </label>
                @can('sparepartvendor_edit')
                <div class="view_user_edit_btn d-inline">
                  <a href="{!! url('/sparepartvendor/list/edit/' . $sparepartvendor->id) !!}">
              ...
              <div class="col-xl-12 col-md-12 col-sm-12 nav_text mt-2">
                <div class="d-lg-inline">
                  <i class=" fa fa-phone"></i> {{ $sparepartvendor->mobile_no }}
                </div>
                <div class="d-lg-inline">
                  <i class=" fa fa-envelope"></i> {{ $sparepartvendor->email }}
                </div>
              </div>
              <div class="col-xl-12 col-md-12 col-sm-12 heading_view mt-3" style="width: 90%;">
                <i class="fa-solid fa-location-dot"></i>
                <lable class="">
                  {{ $sparepartvendor->address }}
                  <!-- , <?php echo getCityName($sparepartvendor->city_id) != null ? getCityName($sparepartvendor->city_id) . ',' : ''; ?>{{ getStateName($sparepartvendor->state_id) }}, {{ getCountryName($sparepartvendor->country_id) }}. -->
                </lable>
              </div>
            </div>
          </div>
    ...
    <div class="panel-body padding_0 pb-0">
      ...
      <div class="row margin_top_15px mx-1">
        <div class="col-xl-3 col-md-3 col-sm-6">
          ...
          <label class="fw-bold">{{ $sparepartvendor->display_name  ?? $sparepartvendor->name }}<br></label>
        </div>
        <div class="col-xl-3 col-md-3 col-sm-6">
          <label class="">{{ trans('message.Date of Birth') }} </label><br>
          <label class="fw-bold">
            @if (!empty($sparepartvendor->birth_date))
            {{ date(getDateFormat(), strtotime($sparepartvendor->birth_date)) }}
            @else
        ...
        <div class="col-xl-3 col-md-3 col-sm-6">
          ...
          <span class="txt_color fw-bold">
            @if ($sparepartvendor->gender == '0')
            <?php echo trans('message.Male'); ?>
            @elseif ($sparepartvendor->gender == '1')
          ...
          <div class="guardian_div mb-3">
            <div class="row">
              ...
              <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                ...
                <label class="fw-bold">
                  {{ $sparepartvendor->landline_no ?? trans('message.Not Added') }}
                </label>
              </div>
              <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                <label class=""> {{ trans('message.Branch') }} : </label>
                <label class="fw-bold">
                  {{ getBranchName($sparepartvendor->branch_id) }}
                </label>
              </div>
          ...
          <div class="guardian_div mb-1">
            ...
            <div class="row">
              <div class="col-xl-6 col-md-6 col-sm-12 mt-1">
                ...
                <label class="fw-bold">
                  {{ getCountryName($sparepartvendor->country_id) }}
                </label>
              </div>
              <div class="col-xl-6 col-md-6 col-sm-12 mt-1">
                <label class=""> {{ trans('message.State') }}: </label>
                <label class="fw-bold">
                  {{ getStateName($sparepartvendor->state_id)  ?? trans('message.Not Added') }}
                </label>
              </div>
              <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                <label class=""> {{ trans('message.Town/City') }}: </label>
                <label class="fw-bold">
                  {{ getCityName($sparepartvendor->city_id)  ?? trans('message.Not Added') }}
                </label>
              </div>
              <!-- <div class="col-xl-6 col-md-6 col-sm-12 mt-1">
                <label class=""> {{ trans('message.Address') }}: </label>
                <label class="text-dark fw-bold">{{ $sparepartvendor->address }}</label>
              </div> -->
            </div>
