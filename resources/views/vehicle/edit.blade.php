            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 input-group-date date" id="">
                  <input type="text" name="modelyear" autocomplete="off" value="{{ $vehicaledit->modelyear }}" class="form-control myDatepicker2" />
                </div>
              </div>
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group ms-1">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 text-end mb-3">
                                    <button type="button" data-bs-target="#responsive-modal-color" data-bs-toggle="modal" class="btn btn-outline-secondary btn-sm newaddvehicledescription mt-0 fl margin-left-0">{{ trans('message.Add/Remove') }}</button><br>
                                </div>
                                            ...
                                            @if(!empty($colors1))
                                                @foreach ($colors1 as $item)
                                                    <tr id="color_id_{{ $item->id }}">
                                                        <td>
                                                            <select name="color[]" class="form-control color" id="tax_{{ $item->id }}" data-id="1" >
                                                                ...
                                                                @if(!empty($color))
                                                                    ...
                                                                    <option value="{{ $colors->id }}" style="background-color:{{ $colors->color_code }}; color: #ffffff; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);" <?php if($colors->id == ($item->color)){ echo"selected"; } ?>>
                                                                        {{ $colors->color }}
                                                                    </option>
                                                                    @endforeach
                                                                @endif
                                                        ...
                                                        <td class="text-center">
                                                            <span class="remove_color" style="cursor: pointer;" data-id="{{ $item->id }}"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
                        ...
                        <div class="row col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 form-group note-row">
                            ...
                            <hr>
                            @foreach ($vehicaledit->notes as $key => $note)
...
<script>
    ...
    $(document).ready(function() {
        ...
        var msg6 = "{{ trans('message.Successfully Submitted') }}";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (newd == '01') {
                            ...
                            $('.model_addname').append("<option sellected value='" + model_name +
                                "'>" + model_name +
                                "</option>");
                            $('.vehi_modal_name').val('');
