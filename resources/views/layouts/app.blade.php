...
<style>
  ...
  i.fa-solid.fa-gear {
    ...
    #backgroundCanvas {
        z-index: 1;
        /* Base layer for the car image */
    }

    #overlayCanvas {
        z-index: 2;
        /* Top layer for marking */
    }
...
<head>
  ...
  rel="stylesheet"> --}}
    <link href="{{ URL::asset('vendors/bootstrap-date-time-picker/bootstrap5/css/bootstrap-datetimepicker.css') }}"
        rel="stylesheet">
    ...
    <script src="{{ URL::asset('vendors/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js') }}" defer="defer">
    </script>
            ...
            <div class="col-md-3 left_col">
                        ...
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                @if (Request::is('domain'))
                                    <li class="w-100 active"><a href="{!! url('/domain') !!}"><i
                                                class="fa-solid fa-gear margin-right-10px"></i>{{ trans('License Settings') }}</a>
                                    </li>
                                @endif
                                ...
                                <li class={{ in_array($currentRoute, $inventoryRoutes) ? 'active' : '' }}><a
                                        href="{!! url('/') !!}"><i
                                            class="fa-solid fa-house margin-right-10px"></i>{{ trans('message.Dashboard') }}
                                    </a></li>
                                ...
                                @canany(['supplier_view', 'product_view', 'purchase_view', 'stock_view'])
                                    ...
                                    @endphp
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/supplier/list/') || Str::startsWith($currentRoute, '/product/list/edit/') || Str::startsWith($currentRoute, '/purchase/list/edit/') ? 'active' : '' }}">

                                        <div class="dropdown w-100">
                                            <a href="#"><i class="fa-solid fa-sliders margin-right-10px"></i>
                                                {{ trans('message.Inventory') }}<span
                                                    class="fa fa-chevron-right dropdown-right-icon icon"> </span></a>
                                ...
                                @canany(['customer_view', 'employee_view', 'supportstaff_view', 'accountant_view',
                                    ...
                                    @endphp
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/customer/list/') || Str::startsWith($currentRoute, '/employee/view/') || Str::startsWith($currentRoute, '/employee/edit/') || Str::startsWith($currentRoute, '/supportstaff/list/') || Str::startsWith($currentRoute, '/accountant/list/') || Str::startsWith($currentRoute, '/branchadmin/list/') ? 'active' : '' }}">

                                        <div class="dropdown w-100">
                                            <a href="#"><i class="fa-regular fa-user margin-right-10px"></i>
                                                {{ trans('message.Users') }}<span
                                                    class="fa fa-chevron-right dropdown-right-icon icon"> </span></a>
                                            <div class="dropdown-content dropdown-content-user">
                                                ...
                                                @can('supportstaff_view')
                                                    <a
                                                        href="{!! url('/supportstaff/list') !!}">{{ trans('message.Support Staff') }}</a>
                                                @endcan
                                                ...
                                                @can('sparepartvendor_view')
                                                    <a
                                                        href="{!! url('/sparepartvendor/list') !!}">{{ trans('message.Spare Part Vendor') }}</a>
                                                @endcan
                                ...
                                @canany(['vehicle_view', 'vehicletype_view', 'vehiclebrand_view', 'colors_view'])
                                    ...
                                    @endphp
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/vehicle/list') || Str::startsWith($currentRoute, '/vehicletype/list/') || Str::startsWith($currentRoute, '/vehiclebrand/list/') || Str::startsWith($currentRoute, '/color/list/edit/') ? 'active' : '' }}">

                                        <div class="dropdown w-100">
                                            <a href="#"><i
                                                    class="fa-solid fa-car-side margin-right-10px"></i>{{ trans('message.Vehicles') }}<span
                                                    class="fa fa-chevron-right dropdown-right-icon icon"> </span></a>
                                            <div class="dropdown-content dropdown-content-vehicle ">
                                                ...
                                                @can('vehicletype_view')
                                                    <a
                                                        href="{!! url('/vehicletype/list') !!}">{{ trans('message.List Vehicle Type') }}</a>
                                                @endcan

                                                @can('vehiclebrand_view')
                                                    <a
                                                        href="{!! url('/vehiclebrand/list') !!}">{{ trans('message.List Vehicle Brand') }}</a>
                                                @endcan

                                                @can('vehiclemodel_view')
                                                    <a
                                                        href="{!! url('/vehicalmodel/list') !!}">{{ trans('message.List Vehicle Model') }}</a>
                                                @endcan
                                ...
                                @can('service_view')
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/service/list/') ? 'active' : '' }}">
                                        <a href="{!! url('/service/list') !!}"><i
                                                class="fa-solid fa-wrench margin-right-10px"></i>{{ trans('message.Services') }}</a>
                                    </li>
                                @endcan
                                ...
                                @can('service_view')
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/service/list/') ? 'active' : '' }}">
                                        <a href="{!! url('/service/list') !!}"><i
                                                class="fa-solid fa-wrench margin-right-10px"></i>{{ trans('message.Tools') }}</a>
                                    </li>
                                @endcan --}}
                                ...
                                @can('quotation_view')
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/quotation/list/') ? 'active' : '' }}">
                                        <a href="{!! url('/quotation/list') !!}"><i
                                                class="fa-solid fa-file-invoice-dollar margin-right-10px"></i>
                                            {{ trans('message.Quotation') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('invoice_view')
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/invoice/') ? 'active' : '' }}">
                                        <a href="{!! url('/invoice/list') !!}"><i
                                                class="fa-solid fa-receipt margin-right-10px"></i>
                                            {{ trans('message.Invoices') }}</a></li>
                                @endcan
                ...
                @endcanany --}}
                                ...
                                {{-- @canany(['jobcard_view', 'gatepass_view'])
                                    ...
                                    @endphp
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/jobcard/') || Str::startsWith($currentRoute, '/gatepass/') ? 'active' : '' }}">
                                        <div class="dropdown w-100">
                                            <a href="#"><i
                                                    class="fa-solid fa-credit-card margin-right-10px"></i>{{ trans('message.Job Card') }}<span
                                                    class="fa fa-chevron-right dropdown-right-icon icon"></span></a>
                                            <div class="dropdown-content dropdown-content-jobcard">
                                                @can('jobcard_view')
                                                    <a
                                                        href="{{ route('newjobcard.list') }}">{{ trans('message.Job Card') }}</a>
                                                @endcan
                                                @can('gatepass_view')
                                                    <a href="{!! url('/gatepass/list') !!}">{{ trans('message.Gate Pass') }}</a>
                                                @endcan
                                ...
                                @php
                                    $inventoryRoutes = ['/jobcard/list'];
                                @endphp
                                @can('jobcard_view')
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/jobcard/') ? 'active' : '' }}">
                                        <a href="{{ route('newjobcard.list') }}"><i
                                                class="fa-solid fa-credit-card margin-right-10px"></i>
                                            {{ trans('message.Job Card') }} </a> </li>
                                @endcan
...
@else
    ...
    @endif
                ...
                <li class="{{in_array($currentRoute,$inventoryRoutes) || Str::startsWith($currentRoute, '/sales_part/') ? 'active' : ''}}"><a href="{!! url('/sales_part/list') !!}"><i class="fa-solid fa-tag margin-right-10px"></i> {{ trans('Purchase Spare Parts') }} </a> </li>
                @else
                ...
                @endcan --}}
                                ...
                                @can('salespart_view')
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/purchase-spare-part/') ? 'active' : '' }}">
                                        <a href="{{ route('purchase_spare_part.list') }}"><i
                                                class="fa-solid fa-tag margin-right-10px"></i>
                                            {{ trans('Purchase Spare Parts') }} </a> </li>
                                @endcan

                                @php
                                    $inventoryRoutes = ['/expense/list', '/expense/add'];
                                @endphp
                                @can('expense_view')
                                    <li
                                        class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/expense/') ? 'active' : '' }}">
                                        <a href="{!! url('/expense/list') !!}"><i
                                                class="fa-solid fa-clipboard-check margin-right-10px"></i>
                                            {{ trans('message.Expenses') }}</a>
                                    </li>
                                @endcan
                ...
                @endcan --}}
                                ...
                                @can('accessory_view')
                                    <li>
                                        <a href="{{ route('accessory.list') }}">
                                            <i
                                                class="fa-solid fa-toolbox margin-right-10px"></i>{{ trans('Accessories') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('parts_view')
                                    <li>
                                        <a href="{{ route('sparepart.list') }}">
                                            <i class="fa-solid fa-cogs margin-right-10px"></i>{{ trans('Parts') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('tools_view')
                                    <li>
                                        <a href="{{ route('tool.list') }}">
                                            <i class="fa-solid fa-wrench margin-right-10px"></i>{{ trans('Tools') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('lubricants_view')
                                    <li>
                                        <a href="{{ route('lubricant.list') }}">
                                            <i class="fa-solid fa-oil-can margin-right-10px"></i>{{ trans('Lubricants') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('units_view')
                                    <li>
                                        <a href="{{ route('unit.list') }}">
                                            <i class="fa-solid fa-oil-can margin-right-10px"></i>{{ trans('Units') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('categories_view')
                                    <li>
                                        <a href="{{ route('category.list') }}">
                                            <i class="fa-solid fa-oil-can margin-right-10px"></i>{{ trans('Categories') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('order_view')
                                    <li>
                                        <a href="{{ route('order.list') }}">
                                            <i class="fa-solid fa-oil-can margin-right-10px"></i>{{ trans('Order') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('stock')
                                    <li>
                                        <a href="{{ route('stock.list') }}">
                                            <i class="fa-solid fa-oil-can margin-right-10px"></i>{{ trans('Stock') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @can('stock')
                                    <li>
                                        <a href="{{ route('stock_history.list') }}">
                                            <i
                                                class="fa-solid fa-oil-can margin-right-10px"></i>{{ trans('Stock History') }}
                                        </a>
                                    </li>
                                @endcan
                                ...
                                @php
                                    $inventoryRoutes = [
                                        '/setting/general_setting/list',
                                        '/setting/timezone/list',
                                        '/setting/accessrights/show',
                                        '/setting/hours/list',
                                        '/setting/stripe/list',
                                        '/branch_setting/list',
                                    ];
                                ...
                                @if (getActiveAdmin(Auth::User()->id) == 'yes')
                                    <li class="{{ in_array($currentRoute, $inventoryRoutes) ? 'active' : '' }}"><a
                                            data-toggle="" data-placement="top" href="{!! url('/setting/general_setting/list') !!}"
                                            title="{{ trans('message.Settings') }}"> <i
                                                class="fa-solid fa-gear margin-right-10px"></i>{{ trans('message.Settings') }}</a>
                                    </li>
                                @else
                                    ...
                                    @else
                                        @can('timezone_view')
                                            <li class="{{ in_array($currentRoute, $inventoryRoutes) ? 'active' : '' }}"><a
                                                    data-toggle="" data-placement="top" href="{!! url('/setting/timezone/list') !!}"
                                                    title="{{ trans('message.Settings') }}"> <i
                                                        class="fa-solid fa-gear margin-right-10px"></i>{{ trans('message.Settings') }}</a>
                                            </li>
                                        @endcan
                                ...
                                @endif
                                <li>
                                    <a class="logoutConfirm margin-right-10px"><i class="fa fa-power-off"
                                            aria-hidden="true"></i>{{ trans('message.Logout') }}</a>
            ...
            <div class="top_nav position-relative">
                ...
                <div class="modal fade" id="bs-example-modal-lg" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg custommodal-lg">
                        <div class="modal-content modal-body-data modelHeaderwidth"
                            style="width: 320px !important;border-radius: 8px 8px 0px 0px !important;">
                ...
                <footer class="footerforallpage bottom-0 bg-white text-center" id="footerforid">
                    <span
                        class="footerbottom me-3">{{ trans('© Copyright 2024 | Garage Master  | All Rights Reserved') }}</span>
                </footer>
            </div>
        </div>
    </div>
  ...
  defer="defer"></script> --}}
    <script src="{{ URL::asset('vendors/bootstrap-date-time-picker/bootstrap5/js/bootstrap-datetimepicker.min.js') }}"
        defer="defer"></script>
    <script
        src="{{ URL::asset('/vendors/bootstrap-date-time-picker/bootstrap5/js/locales/bootstrap-datetimepicker.' . getLangCode() . '.js') }}"
        defer="defer"></script>
        ...
        $(document).ready(function() {
            ...
            checkboxes.change(function() {
                ...
                if (checkedCount === totalRows) {
                    ...
                    false); // Set the "Select All" checkbox to false if not all checkboxes are checked
                }
            });
            ...
            $('#delete-selected-btn').click(function() {
                ...
                if (selectedIds.length === 0) {
                    ...
                    var msg1 = "{{ trans('message.Are You Sure?') }}";
                    var msg2 =
                        "{{ trans('message.You will not be able to recover this data afterwards!') }}";
                    var msg3 = "{{ trans('message.Cancel') }}";
