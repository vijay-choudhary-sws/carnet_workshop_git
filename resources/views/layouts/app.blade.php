          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/customer/list/') || Str::startsWith($currentRoute, '/employee/view/') || Str::startsWith($currentRoute, '/employee/edit/') || Str::startsWith($currentRoute, '/supportstaff/list/') || Str::startsWith($currentRoute, '/accountant/list/') || Str::startsWith($currentRoute, '/branchadmin/list/') ? 'active' : '' }}">
                  ...
                  <div class="dropdown w-100">
                    ...
                    <div class="dropdown-content dropdown-content-user">
                      ...
                      <a href="{!! url('/sparepartvendor/list') !!}">{{ trans('message.Spare Part Vendor') }}</a>
                      @endcan
                ...
                @endphp
                @can('service_view')
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/service/list/') ? 'active' : '' }}"><a href="{!! url('/service/list') !!}"><i class="fa-solid fa-wrench margin-right-10px"></i>{{ trans('message.Tools') }}</a></li>
                @endcan
                ...
                @endphp
                @can('salespart_view')
                    <li class="{{in_array($currentRoute,$inventoryRoutes) || Str::startsWith($currentRoute, '/purchase-spare-part/') ? 'active' : ''}}"><a href="{{ route('purchase_spare_part.list') }}"><i class="fa-solid fa-tag margin-right-10px"></i> {{ trans('Purchase Spare Parts') }} </a> </li>
                @endcan
                ...
                <li>
                  <a href="{{ route('accessory.list') }}">
                    <i class="fa-solid fa-toolbox margin-right-10px"></i>{{ trans('Accessories') }}
                  </a>
                </li>
                @endcan
