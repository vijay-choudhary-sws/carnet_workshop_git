  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="checkbox checkbox-success checkbox-circle mb-2 alert alert-success alert-dismissible fade show">
      ...
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Vehicle Model Deleted Successfully') }}</label>
       @elseif(session('message') == 'Spare Part Added Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Spare Part Added Successfully') }}</label>
      @elseif(session('message') == 'Spare Part Updated Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Spare Part Updated Successfully') }}</label>
      @elseif(session('message') == 'Spare Part Deleted Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Spare Part Deleted Successfully') }}</label>
      @elseif(session('message') == 'Tool Added Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Tool Added Successfully') }}</label>
      @elseif(session('message') == 'Tool Updated Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Tool Updated Successfully') }}</label>
      @elseif(session('message') == 'Tool Deleted Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Tool Deleted Successfully') }}</label>
      @elseif(session('message') == 'Lubricant Added Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Lubricant Added Successfully') }}</label>
      @elseif(session('message') == 'Lubricant Updated Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Lubricant Updated Successfully') }}</label>
      @elseif(session('message') == 'Lubricant Deleted Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Lubricant Deleted Successfully') }}</label>
      @elseif(session('message') == 'Accessory Added Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Accessory Added Successfully') }}</label>
      @elseif(session('message') == 'Accessory Updated Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Accessory Updated Successfully') }}</label>
      @elseif(session('message') == 'Accessory Deleted Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Accessory Deleted Successfully') }}</label>
      @elseif(session('message') == 'Unit Added Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Unit Added Successfully') }}</label>
      @elseif(session('message') == 'Unit Updated Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Unit Updated Successfully') }}</label>
      @elseif(session('message') == 'Unit Deleted Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Unit Deleted Successfully') }}</label>
      @elseif(session('message') == 'Category Added Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Category Added Successfully') }}</label>
      @elseif(session('message') == 'Category Updated Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Category Updated Successfully') }}</label>
      @elseif(session('message') == 'Category Deleted Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Category Deleted Successfully') }}</label>
      @elseif(session('message') == 'Spare Part Vendor Added Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Spare Part Vendor Added Successfully') }}</label>
      @elseif(session('message') == 'Spare Part Vendor Updated Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Spare Part Vendor Updated Successfully') }}</label>
      @elseif(session('message') == 'Spare Part Vendor Deleted Successfully')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.Spare Part Vendor Deleted Successfully') }}</label>
      @endif
