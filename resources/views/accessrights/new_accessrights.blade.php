              ...
              <div class="accordion-item mb-3">
                <h4 class="accordion-header" id="#collapse{{ $get_right->id }}">
                  <a class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $get_right->id }}" aria-expanded="false" aria-controls="collapse{{ $get_right->id }}">
                    ...
                    @elseif($get_right->role_name == 'Spare Part Vendor')
                    {{ trans('message.Spare Part Vendor') }}
                    @endif
                  </a>
                </h4>
                      ...
                      <div class="table-responsive">
                        <table id="supplier" class="table jambo_table table-responsive">
                          ...
                          <tbody>
                            ...
                            <!-- Spare Part Vendor Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Spare Part Vendor') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="sparepartvendor" name="sparepartvendor[]" value="sparepartvendor_view" @if (!empty($regex->sparepartvendor_view)) @if ($regex->sparepartvendor_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="sparepartvendor_{{ $i }}" name="sparepartvendor[]" value="sparepartvendor_add" @if (!empty($regex->sparepartvendor_add)) @if ($regex->sparepartvendor_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="sparepartvendor_{{ $i }}" name="sparepartvendor[]" value="sparepartvendor_edit" @if (!empty($regex->sparepartvendor_edit)) @if ($regex->sparepartvendor_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="sparepartvendor_{{ $i }}" name="sparepartvendor[]" value="sparepartvendor_delete" @if (!empty($regex->sparepartvendor_delete)) @if ($regex->sparepartvendor_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="sparepartvendor_{{ $i }}" name="sparepartvendor[]" value="sparepartvendor_owndata" @if (!empty($regex->sparepartvendor_owndata)) @if ($regex->sparepartvendor_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
                            ...
                            <!-- Accessory Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Accessory') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="accessory" name="accessory[]" value="accessory_view" @if (!empty($regex->accessory_view)) @if ($regex->accessory_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="accessory_{{ $i }}" name="accessory[]" value="accessory_add" @if (!empty($regex->accessory_add)) @if ($regex->accessory_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="accessory_{{ $i }}" name="accessory[]" value="accessory_edit" @if (!empty($regex->accessory_edit)) @if ($regex->accessory_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="accessory_{{ $i }}" name="accessory[]" value="accessory_delete" @if (!empty($regex->accessory_delete)) @if ($regex->accessory_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                               @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="accessory_{{ $i }}" name="accessory[]" value="accessory_owndata" @if (!empty($regex->accessory_owndata)) @if ($regex->accessory_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
                            ...
                            <!-- Tools Access Rights End -->

                            <!-- Tools Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Tools') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="tools" name="tools[]" value="tools_view" @if (!empty($regex->tools_view)) @if ($regex->tools_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="tools_{{ $i }}" name="tools[]" value="tools_add" @if (!empty($regex->tools_add)) @if ($regex->tools_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="tools_{{ $i }}" name="tools[]" value="tools_edit" @if (!empty($regex->tools_edit)) @if ($regex->tools_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="tools_{{ $i }}" name="tools[]" value="tools_delete" @if (!empty($regex->tools_delete)) @if ($regex->tools_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="tools_{{ $i }}" name="tools[]" value="tools_owndata" @if (!empty($regex->tools_owndata)) @if ($regex->tools_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
                            ...
                            <!-- Part Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Part') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="parts" name="parts[]" value="parts_view" @if (!empty($regex->parts_view)) @if ($regex->parts_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="parts_{{ $i }}" name="parts[]" value="parts_add" @if (!empty($regex->parts_add)) @if ($regex->parts_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="parts_{{ $i }}" name="parts[]" value="parts_edit" @if (!empty($regex->parts_edit)) @if ($regex->parts_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="parts_{{ $i }}" name="parts[]" value="parts_delete" @if (!empty($regex->parts_delete)) @if ($regex->parts_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="parts_{{ $i }}" name="parts[]" value="parts_owndata" @if (!empty($regex->parts_owndata)) @if ($regex->parts_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
                            ...
                            <!-- Tool Access Rights End -->

                            <!-- Lubricant Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Lubricant') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="lubricants" name="lubricants[]" value="lubricants_view" @if (!empty($regex->lubricants_view)) @if ($regex->lubricants_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="lubricants_{{ $i }}" name="lubricants[]" value="lubricants_add" @if (!empty($regex->lubricants_add)) @if ($regex->lubricants_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="lubricants_{{ $i }}" name="lubricants[]" value="lubricants_edit" @if (!empty($regex->lubricants_edit)) @if ($regex->lubricants_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="lubricants_{{ $i }}" name="lubricants[]" value="lubricants_delete" @if (!empty($regex->lubricants_delete)) @if ($regex->lubricants_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="lubricants_{{ $i }}" name="lubricants[]" value="lubricants_owndata" @if (!empty($regex->lubricants_owndata)) @if ($regex->lubricants_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
                            ...
                            <!-- Lubricant Access Rights End -->

                            <!-- Unit Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Unit') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="units" name="units[]" value="units_view" @if (!empty($regex->units_view)) @if ($regex->units_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="units_{{ $i }}" name="units[]" value="units_add" @if (!empty($regex->units_add)) @if ($regex->units_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="units_{{ $i }}" name="units[]" value="units_edit" @if (!empty($regex->units_edit)) @if ($regex->units_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="units_{{ $i }}" name="units[]" value="units_delete" @if (!empty($regex->units_delete)) @if ($regex->units_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="units_{{ $i }}" name="units[]" value="units_owndata" @if (!empty($regex->units_owndata)) @if ($regex->units_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
                            ...
                            <!-- Unit Access Rights End -->

                            <!-- Category Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Category') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="categories" name="categories[]" value="categories_view" @if (!empty($regex->categories_view)) @if ($regex->categories_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="categories_{{ $i }}" name="categories[]" value="categories_add" @if (!empty($regex->categories_add)) @if ($regex->categories_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="categories_{{ $i }}" name="categories[]" value="categories_edit" @if (!empty($regex->categories_edit)) @if ($regex->categories_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="categories_{{ $i }}" name="categories[]" value="categories_delete" @if (!empty($regex->categories_delete)) @if ($regex->categories_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="categories_{{ $i }}" name="categories[]" value="categories_owndata" @if (!empty($regex->categories_owndata)) @if ($regex->categories_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
                            ...
                            <!-- Category Access Rights End -->

                            <!-- Order Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Order') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="order" name="order[]" value="order_view" @if (!empty($regex->order_view)) @if ($regex->order_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="order_{{ $i }}" name="order[]" value="order_add" @if (!empty($regex->order_add)) @if ($regex->order_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="order_{{ $i }}" name="order[]" value="order_edit" @if (!empty($regex->order_edit)) @if ($regex->order_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="order_{{ $i }}" name="order[]" value="order_delete" @if (!empty($regex->order_delete)) @if ($regex->order_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @if ($get_right->role_name == 'Spare Part Vendor')
                              <td>
                                <input type="checkbox" class="order_{{ $i }}" name="order[]" value="order_owndata" @if (!empty($regex->order_owndata)) @if ($regex->order_owndata == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              @else
