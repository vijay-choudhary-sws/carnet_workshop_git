<div class="dropdown_profile ulprofile">
    ...
    <a href="javascript:;" class=" dropdown_profile pt-2 pb-2 authpic" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      @if (Auth::user()->role == 'spare_part_vendor')
      <img src="{{ URL::asset('public/spare_part_vendor/' . Auth::user()->image) }}" alt="spare part vendor" width="40px" height="40px" class="rounded  display-right">
      @endif
