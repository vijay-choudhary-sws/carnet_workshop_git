                ...
                <div class="nav_menu">
                    <nav>
                        <div class="nav toggle">
                            ...
                            <a href="{{ route('tool.list') }}" id=""><span class="titleup"><img
                                        src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow">
                                    {{ trans('message.Edit Tool') }}</span></a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
                    <div class="x_content">
                        <div class="x_panel">
                            <br />
                            <form id="vehicleModelAdd-Form" action="{{ route('tool.update') }}" method="post"
                                    ...
                                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                        <select class="form-control col-md-7 col-xs-12 select2-name" name="name" id="name">
                                            @foreach($sparePartLabels as $sparePartLabel)
                                                <option value="{{ $sparePartLabel->title }}" {{ $sparePartLabel->title == $tool->name ? 'selected' : '' }}>{{ $sparePartLabel->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <label
                                ...
                                <div class="row row-mb-0">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                        <textarea name="description" id="description" placeholder="{{ trans('message.Enter Description') }}"
                                            class="form-control col-md-7 col-xs-12" maxlength="30">{{ $tool->description ?? '' }}</textarea>
                                    </div>
                                    <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback">
                                        ...
                                        <div class="col-8 ps-3">
                                            ...
                                            <img src="{{ asset('public/uploads/tool/' . $tool->image) }}" id="imagePreview"
                                                alt="tool Image" class="mt-2" style="width: 52px;">
                                        </div>
                                        <input type="hidden" name="image_old" value="{{ $tool->image }}">
                                    </div>
                                </div>
