...
@section('content')
                ...
                <div class="nav_menu">
                    <nav>
                        <div class="nav toggle">
                            ...
                            <a href="{{ route('category.list') }}" id=""><span class="titleup"><img
                                        src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow">
                                    {{ trans('message.Edit Category') }}</span></a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
                    <div class="x_content">
                        <div class="x_panel">
                            <br />
                            <form id="vehicleModelAdd-Form" action="{{ route('category.update') }}" method="post"
    ...
    {!! JsValidator::formRequest('App\Http\Requests\CategoryRequest', '#vehicleModelAdd-Form') !!}
