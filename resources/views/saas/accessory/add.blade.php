...
@section('content')
                    ...
                    <nav>
                        <div class="nav toggle">
                            ...
                            <a href="{{ route('accessory.list') }}" id=""><span class="titleup"><img
                                    ...
                                    {{ trans('message.Add Accessory') }}</span></a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
                    <div class="x_content">
                        <div class="x_panel">
                            <br />
                            <form id="vehicleModelAdd-Form" action="{{ route('accessory.store') }}" method="post"
    ...
    {!! JsValidator::formRequest('App\Http\Requests\AccessoryRequest', '#vehicleModelAdd-Form') !!}
