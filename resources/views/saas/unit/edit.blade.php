...
@section('content')
                ...
                <div class="nav_menu">
                    <nav>
                        <div class="nav toggle">
                            ...
                            <a href="{{ route('unit.list') }}" id=""><span class="titleup"><img
                                        src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow">
                                    {{ trans('message.Edit Unit') }}</span></a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
                    <div class="x_content">
                        <div class="x_panel">
                            <br />
                            <form id="vehicleModelAdd-Form" action="{{ route('unit.update') }}" method="post"
                                ...
                                <div class="row row-mb-0">
                                    <label
                                        ...
                                        for="title">{{ trans('message.Title') }} <label class="color-danger">*</label>
                                    </label>
                                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                        <input type="text" name="title" id="title" value="{{ $unit->title ?? '' }}"
    ...
    {!! JsValidator::formRequest('App\Http\Requests\UnitRequest', '#vehicleModelAdd-Form') !!}
