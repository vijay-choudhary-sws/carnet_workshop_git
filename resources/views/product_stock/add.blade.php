...
@section('content')
                ...
                <div class="nav_menu">
                    <nav>
                        <div class="nav toggle">
                            ...
                            <a href="{{ route('stock.list') }}" id=""><span class="titleup"><img
                                        src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow">
                                    {{ trans('message.Add Stock') }}</span></a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
                    <div class="x_content">
                        <div class="x_panel">
                            <br />
                            <form id="stockAdd-Form" action="{{ route('stock.store') }}" method="post"
                                enctype="multipart/form-data" data-parsley-validate
                                class="form-horizontal form-label-left stockAddForm">
                                ...
                                <div class="row row-mb-0">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                        <select name="category_id" id="categroy"
                                           ...
                                           <option value="4">Lubricant</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-2 mx-0">
                                        <button type="submit"
                                            class="btn btn-success stockAddSubmitButton">{{ trans('message.SUBMIT') }}</button>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.stockAddSubmitButton', function(e) {
                $('#stockAdd-Form input, #stockAdd-Form select, #stockAdd-Form textarea')
                    .each(
    ...
    {!! JsValidator::formRequest('App\Http\Requests\StockRequest', '#stockAdd-Form') !!}
