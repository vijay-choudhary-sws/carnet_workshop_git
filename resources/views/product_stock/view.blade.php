                ...
                <div class="nav_menu">
                    <nav>
                        <div class="nav toggle">
                            ...
                            <span class="titleup">{{ trans('message.Order Item') }} </span>
                        </div>
                                    ...
                                    @foreach ($order_items as $order_item)
                                        <tr data-user-id="{{ $order_item->id }}"> 
                                            ...
                                            <td>{{ $order_item->total_amount }}</td>  
                                                ...
                                                <button type="button" onclick="accept_order(this,'<?= $order_item->id ?>',1)" class="btn btn-success rounded mx-2">Accept</button>   
                                                <button type="button" onclick="accept_order(this,'<?= $order_item->id ?>',2)" class="btn btn-danger border-0 rounded mx-2">Decline</button>   
