...
//Branch Admin Module
Route::group(['prefix' => 'sparepartvendor'], function () {
	Route::get('/list', ['as' => 'listsparepartvendor', 'uses' => 'SparePartVendorController@index'])->middleware('can:sparepartvendor_view');
	Route::get('/list/{id}', ['as' => 'sparepartvendor/list/{id}', 'uses' => 'SparePartVendorController@branchAdmminShow'])->middleware('can:sparepartvendor_view');
	Route::get('/add', ['as' => 'sparepartvendor', 'uses' => 'SparePartVendorController@addsparepartvendor'])->middleware('can:sparepartvendor_add');
	Route::post('/store', ['as' => 'sparepartvendor', 'uses' => 'SparePartVendorController@storesparepartvendor'])->middleware('can:sparepartvendor_add');

	Route::get('list/edit/{id}', ['as' => 'sparepartvendor', 'uses' => 'SparePartVendorController@sparepartvendorEdit']);
	Route::post('/list/edit/update/{id}', ['as' => 'sparepartvendor/list/edit/update/{id}', 'uses' => 'SparePartVendorController@sparepartvendorUpdate']);

	Route::get('/list/delete/{id}', ['as' => '/sparepartvendor/list/delete/{id}', 'uses' => 'SparePartVendorController@destroy'])->middleware('can:sparepartvendor_delete');
	Route::post('/list/delete', ['as' => '/sparepartvendor/list/delete', 'uses' => 'SparePartVendorController@destroyMultiple'])->middleware('can:sparepartvendor_delete');
});
...
Route::group(['prefix' => 'saas', 'middleware' => 'auth'], function () {
	...
	Route::group(['prefix' => 'workshop'], function () {
		Route::get('/list', ['as' => '/workshop/list', 'uses' => 'WorkShopController@list']);
		Route::get('/add', ['as' => '/workshop/add', 'uses' => 'WorkShopController@addnew']);
		Route::post('/addnew/store', 'WorkShopController@store')->name('workshop.addnew.store');
		Route::get('saas/workshop/list', 'WorkShopController@list')->name('workshop.list');
	});

	Route::group(['prefix' => 'accessory'], function () {
		Route::get('list', [AccessoryController::class, 'index'])->name('accessory.list');
		Route::get('add', [AccessoryController::class, 'add'])->name('accessory.add');
		Route::post('store', [AccessoryController::class, 'store'])->name('accessory.store');
		Route::get('list/delete/{id}', [AccessoryController::class, 'destory'])->name('accessory.destory');
		Route::post('list/delete', [AccessoryController::class, 'destroyMultiple'])->name('accessory.destroyMultiple');
		Route::get('list/edit/{id}', [AccessoryController::class, 'edit'])->name('accessory.edit');
		Route::post('list/update', [AccessoryController::class, 'update'])->name('accessory.update');
	});

	Route::group(['prefix' => 'sparepart'], function () {
		Route::get('list', [SparePartsController::class, 'index'])->name('sparepart.list');
		Route::get('add', [SparePartsController::class, 'add'])->name('sparepart.add');
		Route::post('store', [SparePartsController::class, 'store'])->name('sparepart.store');
		Route::get('list/delete/{id}', [SparePartsController::class, 'destory'])->name('sparepart.destory');
		Route::post('list/delete', [SparePartsController::class, 'destroyMultiple'])->name('sparepart.destroyMultiple');
		Route::get('list/edit/{id}', [SparePartsController::class, 'edit'])->name('sparepart.edit');
		Route::post('list/update', [SparePartsController::class, 'update'])->name('sparepart.update');
	});

	Route::group(['prefix' => 'tool'], function () {
		Route::get('list', [ToolController::class, 'index'])->name('tool.list');
		Route::get('add', [ToolController::class, 'add'])->name('tool.add');
		Route::post('store', [ToolController::class, 'store'])->name('tool.store');
		Route::get('list/delete/{id}', [ToolController::class, 'destory'])->name('tool.destory');
		Route::post('list/delete', [ToolController::class, 'destroyMultiple'])->name('tool.destroyMultiple');
		Route::get('list/edit/{id}', [ToolController::class, 'edit'])->name('tool.edit');
		Route::post('list/update', [ToolController::class, 'update'])->name('tool.update');
	});

	Route::group(['prefix' => 'lubricant'], function () {
		Route::get('list', [LubricantController::class, 'index'])->name('lubricant.list');
		Route::get('add', [LubricantController::class, 'add'])->name('lubricant.add');
		Route::post('store', [LubricantController::class, 'store'])->name('lubricant.store');
		Route::get('list/delete/{id}', [LubricantController::class, 'destory'])->name('lubricant.destory');
		Route::post('list/delete', [LubricantController::class, 'destroyMultiple'])->name('lubricant.destroyMultiple');
		Route::get('list/edit/{id}', [LubricantController::class, 'edit'])->name('lubricant.edit');
		Route::post('list/update', [LubricantController::class, 'update'])->name('lubricant.update');
	});
	...
	Route::group(['prefix' => 'unit'], function () {
		...
		Route::get('list/delete/{id}', [UnitController::class, 'destory'])->name('unit.destory');
		Route::post('list/delete', [UnitController::class, 'destroyMultiple'])->name('unit.destroyMultiple');
		Route::get('list/edit/{id}', [UnitController::class, 'edit'])->name('unit.edit');
		Route::post('list/update', [UnitController::class, 'update'])->name('unit.update');
	});
	...
	Route::group(['prefix' => 'category'], function () {
		...
		Route::get('list/delete/{id}', [CategoryController::class, 'destory'])->name('category.destory');
		Route::post('list/delete', [CategoryController::class, 'destroyMultiple'])->name('category.destroyMultiple');
		Route::get('list/edit/{id}', [CategoryController::class, 'edit'])->name('category.edit');
		Route::post('list/update', [CategoryController::class, 'update'])->name('category.update');
	});

	Route::group(['prefix' => 'subscription'], function () {
		Route::get('/view', ['as' => '/view', 'uses' => 'SubscriptionController@view']);
	});
});
...
Route::middleware('auth')->prefix('purchase-spare-part')->group(function () {
	...
	// Route::post('update', [PurchaseSparePartController::class, 'update'])->name('purchase_spare_part.update');
	// Route::get('delete/{id}', [PurchaseSparePartController::class, 'destory'])->name('purchase_spare_part.destory');
	// Route::post('delete', [PurchaseSparePartController::class, 'destroyMultiple'])->name('purchase_spare_part.destroyMultiple');
