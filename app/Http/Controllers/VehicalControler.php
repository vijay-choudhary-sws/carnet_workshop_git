...
class VehicalControler extends Controller
{
	...
	public function vehicallist()
	{
		...
		if (!isAdmin(Auth::User()->role_id)) {
			...
			} elseif (getUsersRole(Auth::user()->role_id) == 'Support Staff' || getUsersRole(Auth::user()->role_id) == 'Accountant' || getUsersRole(Auth::user()->role_id) == 'Branch Admin' || getUsersRole(Auth::user()->role_id) == 'Spare Part Vendor') {
