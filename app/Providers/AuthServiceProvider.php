...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function registerPostPolicies()
    {
        ...
        //ForBranch Admin Module Policy (Define by Mukesh)
        Gate::define('sparepartvendor_view', function ($user) {
            return $user->hasAccess(['sparepartvendor_view']);
        });
        Gate::define('sparepartvendor_add', function ($user) {
            return $user->hasAccess(['sparepartvendor_add']);
        });
        Gate::define('sparepartvendor_edit', function ($user) {
            return $user->hasAccess(['sparepartvendor_edit']);
        });
        Gate::define('sparepartvendor_delete', function ($user) {
            return $user->hasAccess(['sparepartvendor_delete']);
        });
        Gate::define('sparepartvendor_owndata', function ($user) {
            return $user->hasAccess(['sparepartvendor_owndata']);
        });

        Gate::define('accessory_view', function ($user) {
            return $user->hasAccess(['accessory_view']);
        });

        Gate::define('accessory_add', function ($user) {
            return $user->hasAccess(['accessory_add']);
        });

        Gate::define('accessory_edit', function ($user) {
            return $user->hasAccess(['accessory_edit']);
        });

        Gate::define('accessory_delete', function ($user) {
            return $user->hasAccess(['accessory_delete']);
        });
        

        Gate::define('tools_view', function ($user) {
            return $user->hasAccess(['tools_view']);
        });

        Gate::define('tools_add', function ($user) {
            return $user->hasAccess(['tools_add']);
        });

        Gate::define('tools_edit', function ($user) {
            return $user->hasAccess(['tools_edit']);
        });

        Gate::define('tools_delete', function ($user) {
            return $user->hasAccess(['tools_delete']);
        });

        
        Gate::define('parts_view', function ($user) {
            return $user->hasAccess(['parts_view']);
        });

        Gate::define('parts_add', function ($user) {
            return $user->hasAccess(['parts_add']);
        });

        Gate::define('parts_edit', function ($user) {
            return $user->hasAccess(['parts_edit']);
        });

        Gate::define('parts_delete', function ($user) {
            return $user->hasAccess(['parts_delete']);
        });

        
        Gate::define('lubricants_view', function ($user) {
            return $user->hasAccess(['lubricants_view']);
        });

        Gate::define('lubricants_add', function ($user) {
            return $user->hasAccess(['lubricants_add']);
        });

        Gate::define('lubricants_edit', function ($user) {
            return $user->hasAccess(['lubricants_edit']);
        });

        Gate::define('lubricants_delete', function ($user) {
            return $user->hasAccess(['lubricants_delete']);
        });

        
        Gate::define('units_view', function ($user) {
            return $user->hasAccess(['units_view']);
        });

        Gate::define('units_add', function ($user) {
            return $user->hasAccess(['units_add']);
        });

        Gate::define('units_edit', function ($user) {
            return $user->hasAccess(['units_edit']);
        });

        Gate::define('units_delete', function ($user) {
            return $user->hasAccess(['units_delete']);
        });

        
        Gate::define('categories_view', function ($user) {
            return $user->hasAccess(['categories_view']);
        });

        Gate::define('categories_add', function ($user) {
            return $user->hasAccess(['categories_add']);
        });

        Gate::define('categories_edit', function ($user) {
            return $user->hasAccess(['categories_edit']);
        });

        Gate::define('categories_delete', function ($user) {
            return $user->hasAccess(['categories_delete']);
        });

        
        Gate::define('order_view', function ($user) {
            return $user->hasAccess(['order_view']);
        });

        Gate::define('order_add', function ($user) {
            return $user->hasAccess(['order_add']);
        });

        Gate::define('order_edit', function ($user) {
            return $user->hasAccess(['order_edit']);
        });

        Gate::define('order_delete', function ($user) {
            return $user->hasAccess(['order_delete']);
        });
